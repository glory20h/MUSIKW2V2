...
class Wav2Vec2ForSpeechClassification(Wav2Vec2PreTrainedModel):
    ...
    def merge(self, hidden_states, mode="mean"):
        if mode == "mean":
            ...
            outputs = torch.max(hidden_states, dim=1)[0]
             ...
             raise Exception("The pooling method must be one of ['mean', 'sum', 'max']")
    ...
    def forward(self,
        ...
        hidden_state = self.merge(hidden_states, mode=self.pooling_mode)
